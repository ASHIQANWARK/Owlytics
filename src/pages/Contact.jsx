...
const Contact = () => {
  ...
  const sendWhatsAppMessage = (e) => {
    ...
    window.open(`https://wa.me/+919035514817?text=${whatsappMessage}`, "_blank");
  };

  return (
    <section className="py-16  bg-[#00203c] overflow-x-hidden">
          ...
          <div className="space-y-8">
            <div className="flex items-center p-6 rounded-xl shadow-xl bg-white bg-opacity-40 backdrop-blur-md">
              ...
              <div>
                ...
                <p className="text-lg">www.owlytics.co</p>
              </div>
            </div>
            <div className="flex items-center p-6 rounded-xl shadow-xl bg-white bg-opacity-40 backdrop-blur-md">
              <div className="text-3xl text-[#1d375f] mr-4">
              ...
              <div>
                ...
                <p className="text-lg">+91 9035514817</p>
              </div>
            </div>
            <div className="flex items-center p-6 rounded-xl shadow-xl bg-white bg-opacity-40 backdrop-blur-md">
              <div className="text-3xl text-[#1d375f] mr-4">
              ...
              <div>
                ...
                <p className="text-lg">contact@owlytics.co</p>
              </div>
            </div>
          </div>
