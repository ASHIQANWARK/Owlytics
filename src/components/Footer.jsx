    ...
    <footer className="bg-gradient-to-b from-[#061428] to-[#0b1c3a] text-white">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-300">
            Address: 3rd Floor, Startuppark, Opposite Madiwala Police Station,
            Koramangala 2nd Block, Bengaluru, Karnataka 560068
          </p>
        ...
        <div className="flex flex-col items-center mt-6">
          ...
          <div className="flex space-x-6">
            ...
            <a
              href="https://www.instagram.com/owlytics_co"
            ...
            <a
              href="https://linkedin.com/company/owlytics-co/"
              aria-label="LinkedIn"
              className="text-[#1358f9] transition duration-300 hover:scale-110 hover:opacity-80"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="w-full flex justify-center md:justify-end">
          <iframe
            title="Google Maps"
            src="https://www.google.com/maps?q=3rd%20Floor%20Startuppark%20Opposite%20Madiwala%20Police%20Station%20Koramangala%202nd%20Block%20Bengaluru%20560068&output=embed"
            width="100%"
            height="180"
      ...
      <div className="bg-gray-950 py-4 text-center">
        <p className="text-gray-400 text-sm">
          &copy; 2025 Incubenation . All rights reserved.
        </p>
      </div>
    </footer>
  );
